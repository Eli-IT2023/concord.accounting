...
const ViewAccountlist1 = ({ authrztn, roleType }) => {
    ...
    <div className="h-100 w-100 border bg-white custom-container">
      ...
      <div className="container-fluid mt-3">
        <div className="row">
                  ...
                  >
                    {`${
                      accountName?.amount?.toLocaleString("en-US", {
                        ...
                        maximumFractionDigits: 2,
                        style: "currency",
                        currency: accountName?.currency?.currency_name,
                      }) || "N/A"
                    }`}
                  </span>
                </div>
          ...
          <div
            className={
              roleType?.includes("Management") ? "col-12 col-md-8" : "d-none"
            }
          >
      ...
      <div className={roleType?.includes("Management") ? "w-100" : "d-none"}>
        <div className="row">
          <div className="col-sm">
            <div className="row">
        ...
        <div className="w-100 border">
          <table className="w-100 table-bordered bg-white text-sm">
            {/* Header section */}
            <thead>
              {/* Main category headers */}
              <tr>
                <th
                  className="p-3 text-left bg-gray-100 border-b-2 border-gray-300"
                  rowSpan="2"
                >
                  Date
                </th>
                ...
                <th
                  className="text-center bg-gradient-to-r from-blue-50 to-blue-100 border-b-2 border-gray-300"
                  colSpan="4"
                >
                ...
                <th
                  className="text-center bg-gradient-to-r from-amber-50 to-amber-100 border-b-2 border-gray-300"
                  colSpan="4"
                >
              ...
              <tr>
                {/* Deposit columns */}
                <th className="p-3 text-left font-medium text-blue-700 bg-blue-50 border-b-2 border-blue-200">
                  Payment Method
                </th>
                <th className="p-3 text-left font-medium text-blue-700 bg-blue-50 border-b-2 border-blue-200">
                  From
                ...
                <th className="p-3 text-right font-medium text-blue-700 bg-blue-50 border-b-2 border-blue-200">
                  Amount
                </th>

                {/* Withdraw columns */}
                <th className="p-3 text-left font-medium text-amber-700 bg-amber-50 border-b-2 border-amber-200">
                  Payment Method
                </th>
                <th className="p-3 text-left font-medium text-amber-700 bg-amber-50 border-b-2 border-amber-200">
                  To
                ...
                <th className="p-3 text-right font-medium text-amber-700 bg-amber-50 border-b-2 border-amber-200">
                  Amount
                </th>
              </tr>
            </thead>
