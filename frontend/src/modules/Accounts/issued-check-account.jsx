...
const IssuedCheckAccount = ({ authrztn, roleType }) => {
  ...
  const dataList = filteredData?.map((data, i) => {
  ...
  const columns = [
    ...
    {
      name: "Issued To",
      selector: (row) => row.account_list_id_issued_tos?.account_name,
    },
    {
      name: "Subject From",
                        ...
                        dataList
                          ...
                          .reduce(
                            (total, item) =>
                              ...
                              parseFloat(
                                item.amount *
                                  item.account_list_id_issued_froms?.currency
                                    .currency_rate || 0
                              ),
                            0
                          )
