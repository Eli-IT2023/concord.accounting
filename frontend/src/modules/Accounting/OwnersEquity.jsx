...
const AccountList1 = ({ authrztn, roleType }) => {
            ...
            {authrztn.includes("Equity-Edit") && (
              <>
                ...
                <i
                  ...
                  style={{ cursor: "pointer" }}
                  onClick={() =>
                    navigate(`/accounting/view-equityAccount/${row.id}`)
                  }
                ></i>
              </>
            )}
            ...
            <Modal.Body>
              ...
              <div className="container">
                <div className="row">
                  ...
                  <div
                    className={
                      roleType?.includes("Management") ? "col-12" : "d-none"
                    }
                  >
