  ...
  const handleApprove = () => {
    swal({
      ...
      if (confirmed) {
        try {
          axios
            .post(`${BASE_URL}/expenses/approved`, null, {
              params: {
                id,
                userLoggedID,
              },
  ...
  return (
    <div className="h-100 w-100 border bg-white custom-container">
      <div className="w-100 p-2 d-flex flex-row justify-content-between align-items-center">
        ...
        {/* Button on the right */}
        {authrztn.includes("Expenses-Print") && (
          <div>
            <button
                  ...
                  {isCutoffPosted && (
                    ...
                    >
                      <p className="text-danger">
                        Approval and rejection actions are prohibited since the
                        Expenses Date has already been posted.
                      </p>
                    </div>
                  )}
                </div>
