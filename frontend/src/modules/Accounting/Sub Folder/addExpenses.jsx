...
const AddExpenses = () => {
  ...
  const add = async (e) => {
    ...
    if (form.checkValidity() === false) {
      ...
      dateValidation(expenses_date, setExpenses_date, "Expenses Date");
      swal({
          ...
          axios
            .post(`${BASE_URL}/expenses/createExpenses`, {
              ...
              selected_currency_id:
                currencyId == "null" ? selected_currency_id : currencyId,
              productName,
          ...
          <div className="row mx-auto mt-3">
            <div className="col-sm">
              <div className="col-sm mb-2">
                ...
                <div className="input-group z-0 mb-2">
                  ...
                  <input
                    ...
                    id="inlineFormInputGroup"
                    readOnly={
                      currencyId !== "null" && totalFixedAssetAmount !== "null"
                    }
                  />
                </div>
              </div>
