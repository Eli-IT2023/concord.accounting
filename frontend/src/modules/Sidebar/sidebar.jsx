...
const Sidebar = ({ authrztn }) => {
  ...
  useEffect(() => {
    ...
    if (location.pathname.startsWith("/inventory")) {
      ...
      setNewReportsOpen(false);
      setTaxMngntOpen(false);
    } else if (location.pathname.startsWith("/taxmngnt")) {
      setContentOpen(false);
      setAccountingOpen(false);
      setInventoryOpen(false);
      setSalesOpen(false);
        ...
        <ul className="nav flex-column">
                ...
                <li className="nav-item">
                  <Link
                    ...
                    className={`nav-link ${
                      ...
                      location.pathname.startsWith(
                        "/sales/view-local-bulk-collection"
                      )
                        ? "active"
                        : ""
                    }`}
                ...
                {/* <li className="nav-item">
                  <Link
                    ...
                    className={`nav-link ${
                      ...
                      location.pathname.startsWith(
                        "/sales/view-overseas-bulk-collection"
                      )
                        ? "active"
                        : ""
                    }`}
                  >
                    Close Overseas Collection
                  </Link>
                </li> */}
                <li className="nav-item">
                  <Link
          ...
          <li className="nav-item">
            <div
              ...
              onClick={() => toggleSubMenu("taxmngnt")}
              style={{ cursor: "pointer" }}
            >
              <span>
            ...
            {taxMngntOpen && (
              <ul className="nav flex-column ms-3">
                <li className="nav-item">
                  <Link
                    to="/taxmngnt/tax-settings"
                    className={`nav-link ${
                      location.pathname === "/taxmngnt/tax-settings"
                        ? "active"
                        : ""
                    }`}
                  >
                ...
                <li className="nav-item">
                  <Link
                    // to="/taxmngnt/tax-settingss"
                    style={{
                      cursor: "not-allowed",
                      backgroundColor: "#e9ecef",
                    }}
                    className={`nav-link ${
                      location.pathname === "/taxmngnt/tax-settingss"
                        ? "active"
                        : ""
                    }`}
                  >
                    Withholding Tax Report <i class="fa-solid fa-lock"></i>
                  </Link>
                </li>
              </ul>
            )}
                ...
                {/* {userLoggedID === "11111111-1111-1111-1111-111111111111" && (
                  <li className="nav-item">
                    <Link
                      ...
                      className={`nav-link ${
                        location.pathname === "/settings/packaging"
                          ? "active"
                          : ""
                      }`}
                    >
          ...
          <li className="nav-item">
            <Link
              to="/migration"
              className={`nav-link ${
                location.pathname === "/migration" ? "active" : ""
              }`}
            >
              <span>
