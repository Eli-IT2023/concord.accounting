...
const Dashboard = ({ authrztn, roleType }) => {
  ...
  useEffect(() => {
    ...
    const filteredData = daysOfWeek.map((day) => {
      ...
      // tago pag sales and purchases pag employee
      if (roleType?.includes("Management")) {
        return {
          name: dateString,
          Sales: salesData,
          Purchases: dayData,
        ...
        return {
          name: dateString,
          Sales: maskCurrency(10),
          Purchases: maskCurrency(10),
        };
      }
    });
  ...
  return (
    <>
      {authrztn.includes("Dashboard-View") ? (
        <div className="h-100 w-100" style={{ maxWidth: "100vw" }}>
          <div className="w-100">
            <div
              ...
              <div className="row mx-auto">
                ...
                <div className="col-sm p-2">
                  ...
                  >
                    ...
                    <div className="mt-2">
                      <span className="peso fw-bold fs-4">
          ...
          <div className="w-100 container-fluid mt-2 p-0">
            <div className="row">
              <div className="col-sm p-2">
                <div
          ...
          <div className="w-100 container-fluid mt-2">
            <div className="row">
              <div className="col-sm p-2 w-25">
                <div
                  className="p-4 border bg-white"
                  style={{ borderRadius: "1rem", minHeight: "15.7rem" }}
                >
                            ...
                            <table className="w-100">
                              <thead className="border-bottom">
                                ...
                                <th
                                  className={
                                    roleType?.includes("Management")
                                      ? "text-center text-secondary px-4"
                                      : "d-none"
                                  }
                                  style={{
                                    fontWeight: 500,
          ...
          <div className="row">
            <div className="col-sm p-2 ms-1">
              <div
                className="p-4 border bg-white ms-2"
                style={{ borderRadius: "1rem", height: "26.78rem" }}
              >
                <h5 className="fw-bold">Banks</h5>
                <div
