...
const OldViewBulkCollection = ({
  ...
  const handleApproveRejectLocalCollection = async (e, action) => {
    ...
    if (parseFloat(truncateToTwoDecimals(balance_now)) !== 0) {
      await swal({
    ...
    if (confirmed) {
      try {
        ...
        const res = await axios.post(
          `${BASE_URL}/bulkcollection/approveRejectLocalCollection`,
          {
            id,
            status,
            items,
              ...
              <div className="w-100 border shadow-sm p-3 rounded">
                ...
                <Form validated={validated} onSubmit={handleAddPayment}>
                  ...
                  <Button
                    ...
                    variant="primary"
                    className="w-100 p-2"
                    disabled={balance_now === 0 || !isEditing}
                  >
                    Add Payment
                  </Button>
                </Form>
...
export default OldViewBulkCollection;
