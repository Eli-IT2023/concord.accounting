              ...
              <table className="table table-bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      {currentAssetsData.debitCash?.toLocaleString("en-US", {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      }) || 0.0}
                    </td>
                    <td>
                      {currentAssetsData.creditCash?.toLocaleString("en-US", {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      }) || 0.0}
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      {currentAssetsData.debitBank?.toLocaleString("en-US", {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      }) || 0.0}
                    </td>
                    <td>
                      {currentAssetsData.creditBank?.toLocaleString("en-US", {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      }) || 0.0}
                    </td>
