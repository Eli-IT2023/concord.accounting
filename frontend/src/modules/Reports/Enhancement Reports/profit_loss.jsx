                              ...
                              return (
                                <>
                                  <tr key={index}>
                                    ...
                                    <td className="">{account.account_name}</td>
                                    <td>{account.currency.currency_name}</td>
                                    <td>
                                    ...
                                    <td>{account.currency.currency_rate}</td>
                                    <td>
                                      {(
                                        account.amount *
                                    ...
                                    <td>
                                      {goingAccount.amount
                                        ? (
                                            goingAccount.amount *
                                            goingAccount.currency?.currency_rate
                                          ).toLocaleString("en-US", {
                                            minimumFractionDigits: 2,
                                            maximumFractionDigits: 2,
                                          })
                                    ...
                                    <td
                                      style={{
                                        color:
                                          ...
                                          goingAccount.exchangeGainLoss === 0
                                            ? "black"
                                            : goingAccount.exchangeGainLoss > 0
                                            ? "green"
                                            : "red",
                            ...
                            {previousData.map((data, index) => (
                              <>
                                <tr key={index}>
                                  ...
                                  <td>
                                    {data.system_rate.toLocaleString("en-US", {
                                      minimumFractionDigits: 2,
                                      maximumFractionDigits: 2,
                                    })}
                                  </td>
                                  <td>
                                    {data.system_value.toLocaleString("en-US", {
                                      minimumFractionDigits: 2,
                                      maximumFractionDigits: 2,
                                    })}
                                  </td>
