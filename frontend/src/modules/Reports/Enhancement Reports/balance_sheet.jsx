...
const BalanceSheet1 = () => {
  ...
  const exportToExcel = () => {
    ...
    const sheetData = [
      ...
      // Inventory
      ["Inventory", "", assets?.totalStockManagement || 0],
      ["", "", assets?.totalStockManagement || 0],
                    ...
                    <tr>
                      ...
                      <td className="text-end">
                        {assets?.totalFundsAmount
                          ? assets.totalFundsAmount.toLocaleString("en-US", {
                              style: "currency",
                              currency: "PHP",
                    ...
                    <tr>
                      ...
                      <td className="text-end">
                        {assets?.totalStockManagement
                          ? assets.totalStockManagement.toLocaleString(
                              "en-US",
                              {
                                style: "currency",
                                currency: "PHP",
              ...
              <div className="w-100">
                <table className="table table-bordered mt-4">
                  ...
                  <tbody>
                     ...
                     */}
                    <tr>
                      <td rowSpan="2">Property, Plant, and Equipment (PP&E)</td>
                      <td></td>
                    ...
                    <tr>
                      <td></td>
                      <td className="text-end">
                        <strong className="text-success total-amount">0</strong>
                      </td>
                    </tr>
              ...
              <div className="w-100">
                <table className="table table-bordered mt-4">
                  ...
                  <tbody>
                    {/* Current Liabilities */}
                    <tr>
                      <td rowSpan="5">Current Liabilities</td>
                      <td>Bank Payable</td>
                      <td className="text-end">
                    ...
                    <tr>
                      ...
                      <td className="text-end">
                        {liabilities?.totalPayable
                          ? liabilities?.totalPayable.toLocaleString("en-US", {
                              style: "currency",
                              currency: "PHP",
                              maximumFractionDigits: 2,
                              minimumFractionDigits: 2,
                    ...
                    <tr>
                      ...
                      <td className="text-end">
                        {liabilities?.totalExpenses
                          ? liabilities?.totalExpenses.toLocaleString("en-US", {
                              style: "currency",
                              currency: "PHP",
                              maximumFractionDigits: 2,
                              minimumFractionDigits: 2,
                ...
                <tr>
                  ...
                  <td className="text-end">
                    {ownersEquity?.retainedEarnings
                      ? ownersEquity?.retainedEarnings.toLocaleString("en-US", {
                          style: "currency",
                          currency: "PHP",
                          maximumFractionDigits: 2,
                          minimumFractionDigits: 2,
