...
const Mixer = ({ authrztn, roleType, rbacUserRole }) => {
  ...
  const handleFormCreate = async (e) => {
    ...
    if (form.checkValidity() === false) {
      ...
      swal({
        title: "Are you sure?",
        text: "You are about to create a new mixer.",
        icon: "warning",
        buttons: true,
        dangerMode: true,
      }).then((willCreate) => {
        if (willCreate) {
          axios
            .post(BASE_URL + "/Mixer/Mixer_create", {
              MixerName,
              description,
              status,
              userLoggedID,
            ...
            .then((response) => {
              if (response.status === 200) {
                swal({
                  title: "Mixer Added Successfully!",
                  text: "Mixer has been added successfully.",
                  icon: "success",
                  button: false,
                  timer: 2000,
                }).then(() => {
  ...
  //   setPaginationUrl(BASE_URL + "/Mixer/getMixerSort");
  ...
  const handleFormUpdate = async (e) => {
    ...
    if (form.checkValidity() === false) {
      ...
      swal({
        ...
        if (willEdit) {
          axios
            .post(BASE_URL + "/Mixer/Mixer_edit", {
              MixerName,
              description,
              status,
              userLoggedID,
            ...
            .then((response) => {
              if (response.status === 200) {
                swal({
                  title: "Mixer Updated Successfully!",
                  text: "Mixer has been updated successfully.",
                  icon: "success",
                  button: false,
                  timer: 2000,
                }).then(() => {
  ...
  const handleSearch = (value) => {
    ...
    if (value === "") {
      ...
      setPaginationUrl(BASE_URL + "/Mixer/getMixerBySearch");
      pagination.updateParams({
        searchText: value,
        filterColumn,
        filterStatus,
          ...
          >
            ...
            >
              <Modal.Header closeButton>
                <Modal.Title>Mixer Details</Modal.Title>
              </Modal.Header>
              <Modal.Body>
                <div className="mb-2">
                  <Form.Label className="form-label">
                    Mixer Name <span className="text-danger">*</span>
                  </Form.Label>
                  <Form.Control
                    value={MixerName}
                    required
