...
const ViewBulkPayable = ({ authrztn }) => {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        setPayableList(dataTransaction);
  ...
  useEffect(() => {
    ...
    const totalOrderAmount = payableList.reduce((sum, item) => {
      const amount = parseFloat(item?.payable?.totalPrice) || 0;
      return sum + amount;
    }, 0);
                        ...
                        status === "For-Approval" && (
                          <>
                            <div className="d-flex flex-column gap-2">
                              <div className="d-flex">
                                <button
                                  className="btn btn-outline-danger w-100 px-3 me-3"
                                  type="button"
                                ...
                                <button
                                  ...
                                  disabled={
                                    Math.max(0, parseFloat(totalAmountSum)) !==
                                      parseFloat(
                                        [
                                          ...paymentList.map(
