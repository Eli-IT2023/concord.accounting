...
const useStore = create((set) => ({
  ...
  setClientTransactionId: (value) => set({ clientTransactionId: value }),
  ...
  setModeOfPayment: (value) => set({ modeOfPayment: value }),
    ...
    try {
      axios
        ...
        .then((res) => {
          ...
          set({ clientTransactionId: res.data.client_transaction_id });
          ...
          set({
            currencyRate: res.data.rate || res.data.currency.currency_rate,
          });
          set({ description: res.data.description });
          set({ modeOfPayment: res.data.MOP });
