...
const PendingStatusTab = ({
  ...
  const pendingPayablePagination = useServerPagination(
  ...
  const handleVendorChange = (selected) => {
    ...
    pendingPayablePagination.updateApiUrl(`${BASE_URL}/payable/fetchPayableSs`);
    pendingPayablePagination.updateParams({
      startDate: selectedCutOff?.from,
      endDate: selectedCutOff?.to,
      currencyId,
  ...
  const handleSearch = (value) => {
    ...
    const isMatchingTotalAmount = pendingPayablePagination.data.some((item) =>
    ...
    debounceTimer.current = setTimeout(() => {
      pendingPayablePagination.updateApiUrl(
  ...
  // --- For payable data table fetching ---
  const fetchPayable = () => {
    pendingPayablePagination.updateApiUrl(`${BASE_URL}/payable/fetchPayableSs`);
    pendingPayablePagination.updateParams({
      startDate: selectedCutOff?.from,
  ...
  return (
    <div className="container-fluid">
      ...
      <div className="data-table-cell-width">
        <DataTable
          columns={columns}
          data={pendingPayablePagination.data}
        ...
        />
        <PaginationControls {...pendingPayablePagination} />
      </div>
    </div>
  );
};
