...
const ProductionFinishedCreateTable = ({
  finishedProductRows,
                    ...
                    <tr className="custom-tr">
                      ...
                      <td className="custom-td">
                        <Select
                          ...
                          onMenuOpen={() => {
                            ...
                            if (stock_finish_products.length === 0) {
                              swal({
                                icon: "warning",
                                title: "Warning",
                      ...
                      <td>
                        <Form.Control
                          ...
                          required
                          readOnly={
                            !data.prod_id || finishedProductRows?.length === 1
                          }
                        />
                      </td>
                      ...
                      <td className="p-0">
                        <input
                          ...
                          value={data.prod_uom}
                          readOnly
                          className="form-control form-control-sm p-2 production-td-width"
                        />
                      </td>
                      {/* Finished Product Delete Button */}
                      <td>
                        <button
                          type="button"
                          className="btn btn-sm btn-outline-danger"
                          onClick={() => deleteFinishedProduct(index)}
                          disabled={finishedProductRows?.length === 1}
                        >
...
export default ProductionFinishedCreateTable;
